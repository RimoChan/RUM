...
- 每天可以训练15000个step。这部分成本按`(1740000-608000) / 15000 + 12`算，就是88GPU天。

5090单卡的租赁价格大概是每天$5，现在训练成本才只要$600，原本继续预训练1个动漫模型，典型的花费要超过$50000<sub>(我去问了NoobAI-XL的owner)</sub>，这样1下就省了99%的钱啦！
