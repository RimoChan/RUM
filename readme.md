...
- 每天可以训练15000个step。这部分成本按`(1158000-608000) / 15000 + 12`算，就是49GPU天。

5090单卡的租赁价格大概是每天$5，现在训练成本才只要$400，原本继续预训练1个动漫模型，典型的花费要超过$50000<sub>(我去问了NoobAI-XL的owner)</sub>，这样1下就省了99%的钱啦！当然这个对比其实不公平，正规的$50000的模型其实效果要比我这个好1些。
